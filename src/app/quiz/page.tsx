...
export default function QuizPage() {
  ...
  const dueCards = useMemo(() => store.revisionItems.filter((item) => !item.isDeleted && (item.curationDecision ?? "keep") === "keep" && item.importance !== "not_required" && isDue(item)), [store.revisionItems]);
