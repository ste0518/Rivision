...
import { fileToPackSource, generateQuickPracticeQuestions, generateStudentRevisionPack } from "@/lib/revision-pack-generator";
...
export default function UploadPage() {
  ...
  async function runGeneratePack() {
    ...
    try {
      ...
      const starterPractice = generateQuickPracticeQuestions(studentPack, 5);
      ...
      store.setRevisionItems(result.items, result.rejectedItems, {
        ...
        studentRevisionPack: studentPack,
      });
