...
export function CardForm({
  ...
  const [draft, setDraft] = useState<RevisionItem>(item ?? { id: createId("card"), type: "definition", title: "", conceptName: "", displayTitle: "", cardFront: "", taskPrompt: "Recall the exact definition.", statement: "", sourceFile: "Manual entry", sourceLocation: "source unknown", tags: [], importance: "unknown", questionPrompt: "", answer: "", createdAt: now, updatedAt: now, reviewCount: 0 });
