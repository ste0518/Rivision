const revisionItemSchema = {
  ...
  properties: {
    ...
    cardPurpose: {
      type: "string",
      enum: ["definition_recall", "model_definition", "condition_recall", "theorem_statement", "proof_recall", "formula_recall", "method_steps", "test_statistic", "conceptual_distinction", "application_condition", "calculation_template", "worked_example_pattern", "background_context", "needs_review"],
    },
