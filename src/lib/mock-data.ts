  ...
  return [
    {
      ...
      sourceFile, sourceLocation: "Section 2.1", section: "2.1 Stationarity", tags: ["stationarity", "covariance"], importance: "must_know", cardPurpose: "definition_recall",
    ...
    },
    {
      ...
      sourceFile, sourceLocation: "Section 2.1", section: "2.1 Stationarity", tags: ["stationarity"], importance: "must_know", cardPurpose: "definition_recall",
    ...
    },
    {
      ...
      sourceFile, sourceLocation: "Section 2.2", section: "2.2 Variograms", tags: ["stationarity", "variogram"], importance: "must_know", cardPurpose: "definition_recall",
    ...
    },
    {
      ...
      sourceFile, sourceLocation: "Theorem 3.4", section: "3. Covariance models", tags: ["covariance", "positive semi-definite"], importance: "partial", cardPurpose: "theorem_statement",
    ...
    },
    {
      ...
      sourceFile, sourceLocation: "Section 2.2", section: "2.2 Variograms", tags: ["formula", "variogram"], importance: "must_know", cardPurpose: "formula_recall",
    ...
    },
    {
      ...
      sourceFile, sourceLocation: "Section 5.1", section: "5. Kriging", tags: ["kriging", "BLUP"], importance: "must_know", cardPurpose: "theorem_statement",
