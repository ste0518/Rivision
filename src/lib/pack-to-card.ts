...
export function cardFromDefinition(d: GeneratedDefinitionItem): RevisionItem {
  ...
  return baseItem({
    ...
    sourceExcerpt: d.sourceExcerpt ?? d.grounding?.sourceExcerpt,
...
export function cardFromFormula(f: GeneratedFormulaItem): RevisionItem {
  return baseItem({
    ...
    sourceExcerpt: f.sourceExcerpt ?? f.grounding?.sourceExcerpt,
...
export function cardFromMethod(m: GeneratedMethodTemplate): RevisionItem {
  ...
  return baseItem({
    ...
    sourceExcerpt: steps.slice(0, 700),
...
export function cardFromProof(p: GeneratedProofItem): RevisionItem {
  ...
  return baseItem({
    ...
    sourceLocation: loc,
    sourceExcerpt: p.sourceExcerpt ?? p.grounding?.sourceExcerpt,
